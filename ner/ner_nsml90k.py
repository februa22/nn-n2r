...
def text2text_txt_conll_iterator(txt_path):
    """Yield dicts for NerNsml90kSubword.generate_samples from lines of txt_path.

    Args:
        txt_path: path to txt file with the CoNLL format.
